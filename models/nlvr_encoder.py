...
class BertLayer(nn.Module):
    ...
    def Reduce_token(self, x, reduce_num, temperature=0, self_attn=None, cls_attn=None, token_attn=None, mask=None):
        ...
        if cls_attn is not None and token_attn is not None:
            ...
            if mask is not None:
                mask = vector_gather(mask.unsqueeze(2), indices_sort)[:,:x.shape[1],:].view(B, x.shape[1])
    ...
    def forward(
        ...
        if temperature > 0:
            ...
            patch_mask = attention_mask[:,:,:,1:].view(B, -1)
            ...
            # patch_mask = patch_mask.view(B, 1, 1, -1)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs, sd_txt_ft, lang_feat_all = self.encoder(
            embedding_output,
