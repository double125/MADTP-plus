...
save_path=output/retrieval_flickr_clip_compression_p0.5
mkdir $save_path

python -m torch.distributed.run --nproc_per_node=4 --master_port 20603 compress_retrieval_clip_dtp.py --p 0.5 --epoch 10 \
